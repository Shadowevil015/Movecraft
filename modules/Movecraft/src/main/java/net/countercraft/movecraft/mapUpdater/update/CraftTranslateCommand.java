...
public class CraftTranslateCommand extends UpdateCommand {
    ...
    public void doUpdate() {
        ...
        if(passthroughBlocks.isEmpty()){
            ...
            final Set<MovecraftLocation> confirmed = craft.getSinking() ? invertedHitBox.copyInto(new HashSet<>()) : verifyExterior(invertedHitBox, validExterior);

            //A set of locations that are confirmed to be "exterior" locations
            final Set<MovecraftLocation> failed = Sets.difference(invertedHitBox, confirmed).copyInto(new HashSet<>());
