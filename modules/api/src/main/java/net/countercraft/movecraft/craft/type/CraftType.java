...
final public class CraftType {
    ...
    private static final NamespacedKey CRUISE_SKIP_BLOCKS = buildKey("cruise_skip_blocks"); // Private key used as default for PER_WORLD_CRUISE_SKIP_BLOCKS
    public static final NamespacedKey PER_WORLD_CRUISE_SKIP_BLOCKS = buildKey("per_world_cruise_skip_blocks");
    private static final NamespacedKey VERT_CRUISE_SKIP_BLOCKS = buildKey("vert_cruise_skip_blocks"); // Private key used as default for PER_WORLD_VERT_CRUISE_SKIP_BLOCKS
    ...
    private static final NamespacedKey FUEL_BURN_RATE = buildKey("fuel_burn_rate"); // Private key used as default for PER_WORLD_FUEL_BURN_RATE
    ...
    private static final NamespacedKey DETECTION_MULTIPLIER = buildKey("detection_multiplier"); // Private key used as default for PER_WORLD_DETECTION_MULTIPLIER
    public static final NamespacedKey PER_WORLD_DETECTION_MULTIPLIER = buildKey("per_world_detection_multiplier");
    private static final NamespacedKey UNDERWATER_DETECTION_MULTIPLIER = buildKey("underwater_detection_multiplier"); // Private key used as default for PER_WORLD_UNDERWATER_DETECTION_MULTIPLIER
    ...
    private static final NamespacedKey MIN_HEIGHT_LIMIT = buildKey("min_height_limit"); // Private key used as default for PER_WORLD_MIN_HEIGHT_LIMIT
    ...
    private static final NamespacedKey CRUISE_TICK_COOLDOWN = buildKey("cruise_tick_cooldown"); // Private key used as default for PER_WORLD_CRUISE_TICK_COOLDOWN
    private static final NamespacedKey PER_WORLD_CRUISE_SPEED = buildKey("per_world_cruise_speed"); // Private key used to calculate PER_WORLD_CRUISE_TICK_COOLDOWN
    ...
    private static final NamespacedKey VERT_CRUISE_TICK_COOLDOWN = buildKey("vert_cruise_tick_cooldown"); // Private key used as default for PER_WORLD_VERT_CRUISE_TICK_COOLDOWN
    private static final NamespacedKey PER_WORLD_VERT_CRUISE_SPEED = buildKey("per_world_vert_cruise_speed"); // Private key used to calculate PER_WORLD_VERT_CRUISE_SPEED
    public static final NamespacedKey PER_WORLD_VERT_CRUISE_TICK_COOLDOWN = buildKey("per_world_vert_cruise_tick_cooldown");
    private static final NamespacedKey MAX_HEIGHT_LIMIT = buildKey("max_height_limit"); // Private key used as default for PER_WORLD_MAX_HEIGHT_LIMIT
    public static final NamespacedKey PER_WORLD_MAX_HEIGHT_LIMIT = buildKey("per_world_max_height_limit");
    private static final NamespacedKey MAX_HEIGHT_ABOVE_GROUND = buildKey("max_height_above_ground"); // Private key used as default for PER_WORLD_MAX_HEIGHT_ABOVE_GROUND
